...
export const I18nKo: I18n = {
    ...
    mfa: {
        ...
        otp: {
            ...
            chooseKind: '인증 방법 선택',
            emailDescription: '이메일로 인증 코드를 받습니다.',
            timeDescription: '인증 앱에서 생성되는 시간 기반 코드를 사용합니다.',
            factorName: '인증 수단 이름',
            factorNamePlaceholder: '예: 개인 휴대전화',
            timeSetup: '인증 앱으로 QR 코드를 스캔한 뒤 표시되는 6자리 코드를 입력하세요.',
            qrAlt: '인증 앱에 Rauthy를 추가하기 위한 QR 코드',
            manualSecret: '스캔할 수 없다면 다음 설정 키를 직접 입력하세요:',
            expiresIn: '이 설정의 남은 시간:',
            expired: '인증 앱 설정이 만료되었습니다. 새 QR 코드를 만들어 다시 시도하세요.',
            registered: '일회용 비밀번호 인증 수단이 등록되었습니다.',
            verify: '확인',
            continue: '계속',
            unnamed: '이름 없는 인증 수단',
            loginEmail: '이메일로 전송된 코드를 입력하세요.',
            loginTime: '인증 앱에 표시된 현재 6자리 코드를 입력하세요.',
        },
