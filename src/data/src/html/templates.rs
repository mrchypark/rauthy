...
pub enum HtmlTemplate {
    ...
    IsOtpEnabled(bool),
    IsOtpEmailEnabled(bool),
    IsOtpTimeEnabled(bool),
    IsRegOpen(bool),
...
impl HtmlTemplate {
    ...
    pub fn id(&self) -> &'static str {
        match self {
            ...
            Self::IsOtpEmailEnabled(_) => "tpl_is_otp_email_enabled",
            Self::IsOtpTimeEnabled(_) => "tpl_is_otp_time_enabled",
    ...
    pub fn inner(&self) -> String {
        match self {
            ...
            Self::IsOtpEmailEnabled(i) => i.to_string(),
            Self::IsOtpTimeEnabled(i) => i.to_string(),
